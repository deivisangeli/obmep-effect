...
## alunos que estavam no 9º, 8º e 7º ano 
...
WHERE TP_ETAPA_ENSINO IN (41,11,21,10,20,9)
", censo_2007_path))
...
load("school_guess_allStates_9EF.RData")
dbWriteTable(con, "school_guess_9EF", school_guess, overwrite=TRUE)

load("school_guess_allStates_8EF.RData")
dbWriteTable(con, "school_guess_8EF", school_guess, overwrite=TRUE)

load("school_guess_allStates_7EF.RData")
dbWriteTable(con, "school_guess_7EF", school_guess, overwrite=TRUE)
...
WHEN TP_ETAPA_ENSINO = 20 THEN 19
WHEN TP_ETAPA_ENSINO = 9  THEN 8
END AS TP_ETAPA_ENSINO,

CASE
WHEN a.TP_ETAPA_ENSINO IN (41,11) THEN g9.CO_ENTIDADE_2006
WHEN a.TP_ETAPA_ENSINO IN (21,10) THEN g8.CO_ENTIDADE_2006
WHEN a.TP_ETAPA_ENSINO IN (20,9)  THEN g7.CO_ENTIDADE_2006
END AS CO_ENTIDADE

FROM alunos_2007_clean a

LEFT JOIN school_guess_9EF g9
ON a.CO_ENTIDADE = g9.CO_ENTIDADE_2007

LEFT JOIN school_guess_8EF g8
ON a.CO_ENTIDADE = g8.CO_ENTIDADE_2007

LEFT JOIN school_guess_7EF g7
ON a.CO_ENTIDADE = g7.CO_ENTIDADE_2007
")
...
WHEN TP_ETAPA_ENSINO = 20 THEN 18
WHEN TP_ETAPA_ENSINO = 9  THEN 7
END AS TP_ETAPA_ENSINO,
