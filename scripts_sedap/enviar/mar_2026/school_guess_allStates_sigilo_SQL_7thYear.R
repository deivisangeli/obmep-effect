...
## Predição para alunos do 7º ano do Ensino Fundamental em 2008 
## usando Censo Básico
...
mat2008 AS (
    ...
    WHERE FK_COD_ETAPA_ENSINO IN (9, 20)
),
...
df AS (
    ...
    WHERE
        b.FK_COD_ETAPA_ENSINO_2007 NOT IN (9, 20)
...
save(school_guess, file = file.path(out, "school_guess_allStates_7EF.RData"))
