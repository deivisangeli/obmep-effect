...
###
### obmep_candidates_selected.parquet (script 21) tem UMA LINHA POR
...
###
### Este script desce ao grao de POSICAO. Para cada um dos 1.297.109
...
###
### Saida:
###   obmep_candidates_selected_positions.parquet   uma linha por
###                                                 POSICAO, 18 colunas
###
### Depends on:
###   prep/building_external_data/obmep_candidates_selected.R
...
### 2. TODO USUARIO SELECIONADO TEM DE APARECER, os 1.297.109. Nao e
...
tmp_dir <- file.path(Sys.getenv("TEMP"), "duckdb_tmp_sel_positions")
